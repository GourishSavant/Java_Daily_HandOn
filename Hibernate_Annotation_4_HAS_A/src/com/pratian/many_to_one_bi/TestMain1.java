...
public class TestMain1 {
	...
	public static void main(String[] args) {
		...
		Customer_M_1_Bi customer1= new Customer_M_1_Bi("Chandra",date,"1234567890","chandra@gmaill.com"); 
		...
		Reservation_M_1_Bi reservation1= new Reservation_M_1_Bi( "Confirmed", "Email"); 
		reservation1.setCustomer(customer1);
		session.save(reservation1);
				 
		// Create Reservation and save it to DB
		Reservation_M_1_Bi reservation2= new Reservation_M_1_Bi( "Pending", "Person"); 
		reservation2.setCustomer(customer1); 
		session.save(reservation2);
				 
		// Create Reservation and save it to DB
		Reservation_M_1_Bi reservation3= new Reservation_M_1_Bi( "Cancelled", "Email"); 
		reservation3.setCustomer(customer1); 
		customer1.setReservation(reservation3);
